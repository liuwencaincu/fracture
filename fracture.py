...
ALP = col2.number_input('ALP')
calcium = col2.number_input('calcium')
hemoglobin = col2.number_input('hemoglobin',value=100)
Mean_corpuscular_volume = col3.number_input('Mean corpuscular volume')
absolute_value_of_lymphocytes = col3.number_input('absolute value of lymphocytes')
Fibrinogen = col3.number_input('Fibrinogen')
